 ...
 * This runs after `npm install -g claude-codex-loop` to warn users early
...
try {
  ...
  console.log(`\x1b[32m✔\x1b[0m Claude Codex Loop: Bun ${version} detected.`);
} catch {
  console.warn(`
\x1b[33m⚠ Claude Codex Loop requires Bun (v1.0+) as its runtime.\x1b[0m
