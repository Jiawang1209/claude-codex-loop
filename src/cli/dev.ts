...
export async function runDev() {
  ...
  console.log("  claude-codex-loop claude    # Start Claude Code (plugin auto-loaded)");
  console.log("  claude-codex-loop codex     # Start Codex TUI");
  console.log("");
  console.log("Code changed? Run 'claude-codex-loop dev' again, then restart Claude Code or /reload-plugins.");
}
