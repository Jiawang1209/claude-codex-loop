...
export async function runInit() {
  console.log("Claude Codex Loop Init\n");
  ...
  console.log("Installing Claude Codex Loop plugin...");
  try {
    ...
    console.log(`    ccl dev   # registers marketplace and installs plugin`);
  }
  console.log("");
  ...
  console.log("  2. Start Claude Code:  claude-codex-loop claude");
  console.log("  3. Start Codex TUI:    claude-codex-loop codex");
}
